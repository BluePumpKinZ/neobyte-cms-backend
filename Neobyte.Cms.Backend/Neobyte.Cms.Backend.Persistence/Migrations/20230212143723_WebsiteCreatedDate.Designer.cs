...
namespace Neobyte.Cms.Backend.Persistence.Migrations
{
    ...
    [Migration("20230212143723_WebsiteCreatedDate")]
    partial class WebsiteCreatedDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Neobyte.Cms.Backend.Persistence.Entities.Websites.SnippetEntity", b =>
                {
                    ...
                    b.Property<Guid?>("WebsiteEntityId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Neobyte.Cms.Backend.Persistence.Entities.Websites.SnippetEntity", b =>
                {
                    ...
                    b.HasOne("Neobyte.Cms.Backend.Persistence.Entities.Websites.WebsiteEntity", null)
                        .WithMany("Snippets")
